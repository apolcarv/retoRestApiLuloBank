...
public class CorruptAPIConsultEmployeesQuestion implements Question {
    @Override
    ...
    public static CorruptAPIConsultEmployeesQuestion validAPICorrupt() {
        return new CorruptAPIConsultEmployeesQuestion();
    }
}
