...
public class GetUpdateEmployee implements Interaction {
    private EnvironmentVariables environmentVariables;
    private static final String LOG_CLASE = "GetUpdateEmployee -> ";
    private static final String MENSAJE_GENERAL = "El servicio se consumio de forma exitosa";
    private final String resources;

    public GetUpdateEmployee(String resources) {
    ...
    public static GetUpdateEmployee service (String resources){
        return Tasks.instrumented(GetUpdateEmployee.class,resources);
    }
}