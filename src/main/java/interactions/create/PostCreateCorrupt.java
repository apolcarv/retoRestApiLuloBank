...
public class PostCreateCorrupt implements Interaction {
    ...
    public PostCreateCorrupt(String resources, String bodyName) {
    ...
    public static PostCreateCorrupt service (String recources, String bodyName){
        return Tasks.instrumented(PostCreateCorrupt.class,recources,bodyName);
    }
}